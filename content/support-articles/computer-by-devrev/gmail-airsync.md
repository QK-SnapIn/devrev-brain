...
The Gmail AirSync enables seamless migration of emails from Gmail into DevRev,
...
1. Go to the **Marketplace**, search for **Gmail** in the **Import**
...
4. In the **Select Connection** dropdown, choose **Gmail**.If a connection already exists, you can reuse it; otherwise, click **Add
   ...
   account using OAuth**.Provide the necessary permissions and click **Continue** to complete the
   setup.
...
## Source
- DevRev support article [Gmail AirSync](https://support.devrev.ai/en-US/devrev/article/6xVVbQpB) (ART-22004)
