...
Tasks are lightweight work items (like personal to-dos) that DevRev offers in addition to the more complex and richer work management records like issues, tickets, and opportunities. Unlike the mentioned work objects, tasks have been designed purposefully to be very simple.
...
This diagram represents the **Task Transitions** workflow in DevRev, organized into three main groups:
...
## Source
- DevRev support article [Tasks](https://support.devrev.ai/en-US/devrev/article/UR_DDUpg) (ART-21851)
