...
Seamlessly import your knowledge base, tickets, and users from ManageEngine ServiceDesk Plus to DevRev.
...
1. In Marketplace, search for **ManageEngine ServiceDesk Plus** and install the snap-in.
2. In the snap-in config modal, click **Install**, then go to **Integrations > AirSyncs** in your settings left nav.
3. Click the **AirSync** button and select the ManageEngine ServiceDesk Plus tile in the Start import window.
4. Create a new connection to your ServiceDesk Plus account, or use an existing connection if you already have one.
...
6. Once the connection is established, select the ServiceDesk Plus portal you want to import, and specify the DevRev part that should be used for any imported work. This initiates a bulk import of the selected portal.
