...
summary: "The ServiceNow KB AirSync simplifies migration from ServiceNow to DevRev, supporting both one-time imports and Periodic Sync."
---

# ServiceNow KB AirSync

The ServiceNow KB [[glossary/airsync|AirSync]] simplifies migration from ServiceNow to DevRev, supporting both one-time imports and Periodic Sync.
...
| --- | --- | --- |
| User | DevUser | ✅ |
| [[features/knowledge-base|Knowledge Base]] | Collection | ✅ |
| Knowledge Category | Tag | ✅ |
| Tag | Tag | ✅ |
| User Criteria | [[entities/group|Group]] | ✅ |
...
1. Login to DevRev.
2. Go to **Settings > Integrations > Snap-ins**, [[features/search|search]] for **ServiceNow KB** under **All Snap-ins**.
...
5. Specify the **DevRev [[entities/part|part]]** where the imported content should reside. Click **Start**.
...
- **Basic Permissions**: Preserves knowledge base and article permissions in DevRev's [[entities/article|articles]]. Only can read and can contribute permissions are imported from the knowledge base and articles.
...
- **Excluded Features**: Custom widgets, [[features/workflows|workflows]], and scripted criteria are not imported.
