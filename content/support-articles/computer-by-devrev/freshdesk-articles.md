...
5. Select the Freshdesk domain and specific knowledge base content you want to import, and specify the DevRev part that should be used for any imported work (future releases make use of this), after the connection is established. This initiates a bulk import of the selected content.
