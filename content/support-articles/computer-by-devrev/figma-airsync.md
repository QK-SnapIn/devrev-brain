...
The Figma AirSync simplifies migration from Figma to DevRev, supporting both
...
1. Go to **Marketplace**, search for **Figma**,
...
4. Create a new connection to your Figma account by either:- Authorizing through OAuth, or
   - Providing your Personal Access Token (PAT)
5. Once the connection is established, select the Figma projects you want to
   import and specify the DevRev part that should be used for any imported
...
6. DevRev automatically maps the fields from Figma to the corresponding fields
   ...
   files being imported. It can take seconds for accounts with only a few files
