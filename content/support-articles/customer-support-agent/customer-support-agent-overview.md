---
title: Customer Support Agent overview
devrev_id: ART-21829
parent_directory: Customer Support Agent
translation_group: HWipyCxT
modified_date: "2026-03-05T21:54:33.802Z"
source_url: "https://support.devrev.ai/en-US/devrev/article/HWipyCxT"
tags: []
...
The [Plug widget SDK](https://developer.devrev.ai/public/sdks) integrates DevRev's customizable widget into websites, with [methods](https://developer.devrev.ai/public/sdks/web/methods) providing the framework for customer support interactions.

### 🎞️ Session recording and analytics

[[support-articles/computer-plus-observe/session-analytics-overview|Session analytics]] captures user website interactions through recordings and detailed logging, enabling businesses to visualize behavior patterns, analyze conversion funnels, and optimize user experience through Computer for User Insights.
...
To incorporate Plug features into your website, refer to the [Web SDK documentation](https://developer.devrev.ai/public/sdks).
