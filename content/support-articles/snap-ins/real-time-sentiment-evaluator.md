---
title: Real-time sentiment evaluator
devrev_id: ART-21946
parent_directory: Automate
translation_group: gS0gsYnl
modified_date: "2025-12-10T06:57:19.968Z"
source_url: "https://support.devrev.ai/en-US/devrev/article/gS0gsYnl"
tags: []
...
1. Install the [Real-time sentiment evaluator snap-in](https://devrev.ai/marketplace/realtime-sentiment-evaluator) from the DevRev marketplace.
2. Select the workspace to install the snap-in, and click **Install**.

![Real-time sentiment evaluator](don:core:dvrv-us-1:devo/0:artifact/4100686)

## Configuration

1. Post installing the snap-in, choose the number of recent customer messages to evaluate for generating the customer sentiment.
2. Click **Save** and **Install Snap-in**.
