...
The [Auto-link DevRev GitHub accounts](https://marketplace.devrev.ai/auto-link-github-accounts) snap-in links GitHub accounts to corresponding DevRev accounts at scale. The snap-in supports automatic creation of shadow users for inactive DevRev accounts and handles the conversion to active users upon their first login.
...
## Source
- DevRev support article [Auto-link DevRev GitHub accounts](https://support.devrev.ai/en-US/devrev/article/lU6Qkrc-) (ART-21923)
