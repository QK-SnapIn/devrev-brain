---
title: Tracxn Integration
devrev_id: ART-21986
parent_directory: Integrate
translation_group: _stkZdzG
modified_date: "2025-12-10T06:57:44.563Z"
source_url: "https://support.devrev.ai/en-US/devrev/article/_stkZdzG"
tags: []
top_category: Snap-ins
wiki_match: features/jira-integration
match_score: 0.824
...
4. In DevRev app, setup the connection in **Settings** > **Snap-ins** > **Connections** on top.
   ...
   c. Give it a name and paste your Tracxn API private key in the **Secret** field.
   d. If you want to make the connection public for your organization, toggle on **Make public**.
5. Update the snap-in configurations as needed.
6. Deploy the snap-in.

### How to uninstall

1. Go to menu located under **Snap-ins > Tracxn Integration**.
2. Select **Remove snap-in** to permanently delete the snap-in from your organization.
