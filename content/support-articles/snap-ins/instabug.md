...
summary: "Seamlessly bring user feedback from Instabug into DevRev."
---

# Instabug

Seamlessly bring user feedback from Instabug into DevRev. DevRev's Instabug
integration enables you to create [[features/tickets|tickets]] or [[features/issues|issues]] automatically when an
Instabug user creates a report, linking it to a specific [[entities/part|part]] of your product,
...
3. [[features/search|Search]] for **Instabug** and click **Install** next to the **Instabug**
   snap-in.
4. In the DevRev app, configure the snap-in in **Settings** > **Snap-ins** >
   ...
   * Select the DevRev work item type ([[entities/issue|issue]] or [[entities/ticket|ticket]]) for Instabug reports.
   * Click **Save** > **Install**
...
## Source
- DevRev support [[entities/article|article]] [Instabug](https://support.devrev.ai/en-US/devrev/article/-bgE7TbV) (ART-21984)
