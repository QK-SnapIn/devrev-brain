...
The [Slack scraper snap-in](https://marketplace.devrev.ai/marketplace/slack-scraper) scrapes a channel of all messages, determines what of the conversation is important data and stores this parsed data into a DevRev article. If the scraper is called again, it updates the article with data since the channel was last scraped.
