...
category: airsync
source_url: https://developer.devrev.ai/airsync/load-attachments
last_updated: 2026-05-11
summary: "In the load attachments phase, the snap-in saves each attachment to the external system."
---
...
Once the attachment loading is done, the snap-in must respond to AirSync with a message with event type `ATTACHMENT_LOADING_DONE`.
...
Previous Page](/airsync/load-data)[Object Mappers

Next Page](/airsync/object-mappers)

## Source
- DevRev developer docs: [Load attachments](https://developer.devrev.ai/airsync/load-attachments)
