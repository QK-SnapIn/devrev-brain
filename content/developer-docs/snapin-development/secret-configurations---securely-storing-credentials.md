---
title: Secret configurations - Securely storing credentials
type: developer-doc
status: stable
source: developer.devrev.ai
category: snapin-development
source_url: https://developer.devrev.ai/snapin-development/references/keyrings/secret-configuration
last_updated: 2026-05-11
summary: "Secret configurations are a type of keyring well-suited for storing credentials like personal access tokens (PATs) and multi-field tokens (often stored in JSON format)."
---
...
## [Multi-field keyrings](#multi-field-keyrings)
...
## [Basic authentication with keyrings](#basic-authentication-with-keyrings)
...
## Source
- DevRev developer docs: [Secret configurations - Securely storing credentials](https://developer.devrev.ai/snapin-development/references/keyrings/secret-configuration)
