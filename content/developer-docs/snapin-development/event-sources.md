...
source_url: https://developer.devrev.ai/snapin-development/references/event-sources
last_updated: 2026-05-11
summary: "You can provide custom instructions for each event source."
---
...
## [Supported event source types and their event types](#supported-event-source-types-and-their-event-types)
...
## [Event source instructions](#event-source-instructions)
...
### [Webhook-event-request example:](#webhook-event-request-example)
...
The `/event-sources.schedule` API is currently in early access. For API details, see [event-sources-schedule-event](https://developer.devrev.ai/beta/api-reference/event-sources/schedule-event).

To cancel scheduled events, you can utilize the `/event-sources.unschedule` API. For API details, see [event-sources-delete-scheduled-event](https://developer.devrev.ai/beta/api-reference/event-sources/schedule-event).

## [Generic event sources](#generic-event-sources)
...
## [Timer-based event sources](#timer-based-event-sources)
...
## [Email-based event sources](#email-based-event-sources)
...
## Source
- DevRev developer docs: [Event sources](https://developer.devrev.ai/snapin-development/references/event-sources)
