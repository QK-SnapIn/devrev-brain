...
source_url: https://developer.devrev.ai/snapin-development/references/inputs
last_updated: 2026-05-11
summary: "Inputs are settings for a snap-in that allows behavior customization."
---
...
Previous Page](/snapin-development/references/event-sources)[Commands

Next Page](/snapin-development/references/commands)

## Source
- DevRev developer docs: [Inputs](https://developer.devrev.ai/snapin-development/references/inputs)
