...
source_url: https://developer.devrev.ai/snapin-development/tutorials/perform-external-action
last_updated: 2026-05-11
summary: "In this tutorial, you learn how to develop a snap-in that mirrors an issue from DevRev to GitHub."
---
...
2. **Secrets and keyrings in DevRev snap-ins:**
   ...
   * Explore the usage of secrets and refer to
     [keyrings](https://developer.devrev.ai/snapin-development/references/keyrings/keyring-intro) in DevRev snap-ins.
...
To facilitate authentication for our API calls, the initial step involves creating a Personal Access Token (PAT) in GitHub. This PAT can be stored as a [connection](https://developer.devrev.ai/snapin-development/references/keyrings/keyring-intro) within DevRev. Subsequently, this
...
#### [Step 2: Add PAT to DevRev connections](#step-2-add-pat-to-devrev-connections)
...
#### [Step 3: Install the snap-in](#step-3-install-the-snap-in)
...
Previous Page](/snapin-development/tutorials/timer-ticket-creator)[Snap-in triggered by a DevRev event

Next Page](/snapin-development/tutorials/triggered-event)

## Source
- DevRev developer docs: [Using a snap-in to perform an external action](https://developer.devrev.ai/snapin-development/tutorials/perform-external-action)
