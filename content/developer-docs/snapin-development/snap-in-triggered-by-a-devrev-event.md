...
source_url: https://developer.devrev.ai/snapin-development/tutorials/triggered-event
last_updated: 2026-05-11
summary: "In this tutorial, you'll learn to create a dynamic snap-in that responds to both DevRev Webhook events triggered by the creation of a work and specialized command within DevRev."
---
...
To learn more, refer to the [Using a snap-in to perform a DevRev action](https://developer.devrev.ai/snapin-development/tutorials/timer-ticket-creator) tutorial.
...
### [Getting the payload](#getting-the-payload)
...
### [Handling DevRev event](#handling-devrev-event)
...
### [Handling command event](#handling-command-event)
...
## Source
- DevRev developer docs: [Snap-in triggered by a DevRev event](https://developer.devrev.ai/snapin-development/tutorials/triggered-event)
