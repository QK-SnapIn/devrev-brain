...
source_url: https://developer.devrev.ai/snapin-development/debugging
last_updated: 2026-05-11
summary: "Using DevRev CLI, you can retrieve build logs and runtime logs for your snap-ins."
---
...
## [Retrieving logs for snap-in](#retrieving-logs-for-snap-in)

Using DevRev CLI, you can retrieve build logs and runtime logs for your snap-ins.

### [How to retrieve logs using DevRev CLI](#how-to-retrieve-logs-using-devrev-cli)
...
### [Error "You are not authorized to perform this operation"](#error-you-are-not-authorized-to-perform-this-operation)
...
## Source
- DevRev developer docs: [Debugging](https://developer.devrev.ai/snapin-development/debugging)
