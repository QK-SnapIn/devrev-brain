...
source_url: https://developer.devrev.ai/snapin-development/best-practices
last_updated: 2026-05-11
summary: "When writing an automation that listens to a webhook event, ensure you check for the specific conditions you want to act on."
---
...
## [Act on specific webhook conditions](#act-on-specific-webhook-conditions)
...
## [Use the DevRev SDK](#use-the-devrev-sdk)
...
## [Think from a snap-in installer perspective](#think-from-a-snap-in-installer-perspective)
...
Previous Page](/snapin-development/references/customizing-snap-in-configuration)[Locally testing snap-ins

Next Page](/snapin-development/locally-testing-snap-ins)

## Source
- DevRev developer docs: [Development best practices](https://developer.devrev.ai/snapin-development/best-practices)
