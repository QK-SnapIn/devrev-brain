...
source_url: https://developer.devrev.ai/snapin-development/references/snap-components
last_updated: 2026-05-11
summary: "Snap components enable adding custom UI components defined by snap-kit to the DevRev UI."
---
...
## [Format of context passed to snap-kit action](#format-of-context-passed-to-snap-kit-action)
...
## [List of surfaces](#list-of-surfaces)
...
## Source
- DevRev developer docs: [Snap Components](https://developer.devrev.ai/snapin-development/references/snap-components)
