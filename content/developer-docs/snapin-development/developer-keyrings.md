...
source_url: https://developer.devrev.ai/snapin-development/references/keyrings/developer-keyring
last_updated: 2026-05-11
summary: "In addition to keyrings for storing user or organization credentials, DevRev also offers a special type called developer keyrings."
---
...
## [Snap-in secrets](#snap-in-secrets)
...
## [Developer keyrings in the snap-in manifest](#developer-keyrings-in-the-snap-in-manifest)
...
Previous Page](/snapin-development/references/keyrings/secret-configuration)[Event sources

Next Page](/snapin-development/references/event-sources)

## Source
- DevRev developer docs: [Developer keyrings](https://developer.devrev.ai/snapin-development/references/keyrings/developer-keyring)
