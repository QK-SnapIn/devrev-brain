...
source_url: https://developer.devrev.ai/snapin-development/references/customizing-snap-in-configuration
last_updated: 2026-05-11
summary: "The DevRev snap-ins platform allows developers to define custom configuration pages for their snap-ins."
---
...
## [Defining custom configuration pages](#defining-custom-configuration-pages)
...
## [Update snap-in inputs (beta)](#update-snap-in-inputs-beta)
...
Previous Page](/snapin-development/references/snap-in-resources)[Development best practices

Next Page](/snapin-development/best-practices)

## Source
- DevRev developer docs: [Customizing snap-in configuration](https://developer.devrev.ai/snapin-development/references/customizing-snap-in-configuration)
