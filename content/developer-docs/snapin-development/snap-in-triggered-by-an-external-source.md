---
title: Snap-in triggered by an external source
type: developer-doc
status: stable
source: developer.devrev.ai
category: snapin-development
source_url: https://developer.devrev.ai/snapin-development/tutorials/triggered-external-source
last_updated: 2026-05-11
summary: "In this tutorial, you'll learn how to create a snap-in that responds to an external source, particularly GitHub."
---
...
### [Functions and automations](#functions-and-automations)
...
## Source
- DevRev developer docs: [Snap-in triggered by an external source](https://developer.devrev.ai/snapin-development/tutorials/triggered-external-source)
