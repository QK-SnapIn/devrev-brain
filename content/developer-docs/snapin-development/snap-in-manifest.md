...
source_url: https://developer.devrev.ai/snapin-development/references/manifest
last_updated: 2026-05-11
summary: "The following section is for version 2 of the manifest specification."
---
...
The following section is for version 2 of the manifest specification. For the previous version, see [Manifest V1](https://developer.devrev.ai/snapin-development/references/v1-manifest).
...
To view the supported connection types, see [Keyrings](https://developer.devrev.ai/snapin-development/references/keyrings/keyring-intro).

## [Developer keyrings](#developer-keyrings)
...
## Source
- DevRev developer docs: [Snap-in manifest](https://developer.devrev.ai/snapin-development/references/manifest)
