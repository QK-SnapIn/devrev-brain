...
source_url: https://developer.devrev.ai/snapin-development/tutorials/getting-started
last_updated: 2026-05-11
summary: "In this tutorial, you'll learn to create and deploy a snap-in."
---
...
### [Log in to DevRev for authentication](#log-in-to-devrev-for-authentication)
...
### [Initialize a snap-in template](#initialize-a-snap-in-template)
...
To create a [snap-in package](https://developer.devrev.ai/snapin-development/concepts), run the following command:
...
2. On successful creation, the CLI automatically stores the package ID in its context corresponding to the slug. For more information, refer to the [Snap-in Context](https://developer.devrev.ai/snapin-development/references/cli#snap-in-context).

### [Create a snap-in version](#create-a-snap-in-version)

To create a [snap-in version](https://developer.devrev.ai/snapin-development/references/cli#snap-in-version), run the following command:
...
The CLI automatically stores the version ID in its context. Refer to the [Snap-in Context](https://developer.devrev.ai/snapin-development/references/cli#snap-in-context) section for more information.
...
### [Install a snap-in from a snap-in version](#install-a-snap-in-from-a-snap-in-version)
...
The CLI automatically stores the snap-in ID in its context. Refer to the [Snap-in Context](https://developer.devrev.ai/snapin-development/references/cli#snap-in-context) section for more information.

### [Configure the snap-in](#configure-the-snap-in)
...
### [Deploy the snap-in](#deploy-the-snap-in)
...
### [Check snap-in logs](#check-snap-in-logs)
...
### [Delete the snap-in](#delete-the-snap-in)
...
### [Upgrade the snap-in](#upgrade-the-snap-in)
...
Previous Page](/snapin-development/tutorials/overview)[Using a snap-in to perform a DevRev action

Next Page](/snapin-development/tutorials/timer-ticket-creator)

## Source
- DevRev developer docs: [Getting started](https://developer.devrev.ai/snapin-development/tutorials/getting-started)
