...
category: guides
source_url: https://developer.devrev.ai/guides/timeline-entries
last_updated: 2026-05-11
summary: "In this tutorial, you'll learn how to send restricted visibility messages on the timeline of an object by using the timeline-entries-create API."
---
...
The [timeline entries](https://developer.devrev.ai/api-reference/timeline-entries/create) API is used to create discussions (comments) on the timeline of an object such as a ticket or issue. These messages can be sent by users or by a bot.
...
### [Send a restricted visibility message](#send-a-restricted-visibility-message)
...
1. Get the [object ID](https://developer.devrev.ai/api-reference/getting-started) and object type where you want to send a message.

> Example: In issue `ISS-69`, `69` is the object ID and `ISS` indicates the object type `issue`.

2. Get the `dev-org-id` and `partition` by making a call to the [`dev-users.self` API](https://developer.devrev.ai/api-reference/getting-started#send-your-first-api-request).
...
![private-message](/_next/image?url=%2F_next%2Fstatic%2Fmedia%2Fprivate-message.b688d1ac.png&w=3840&q=75&dpl=dpl_7YrfNpbg1U18B9yV3zCtUk5bPEKN)
...
## Source
- DevRev developer docs: [Restricted messages on a timeline](https://developer.devrev.ai/guides/timeline-entries)
