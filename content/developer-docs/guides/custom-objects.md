...
category: guides
source_url: https://developer.devrev.ai/guides/custom-objects
last_updated: 2026-05-11
summary: "Custom objects allow you to extend DevRev's data model beyond the standard use-cases served by the native apps like Build and Support."
---
...
### [Update custom objects](#update-custom-objects)
...
### [Use unique keys for custom objects](#use-unique-keys-for-custom-objects)
...
## Source
- DevRev developer docs: [Custom objects](https://developer.devrev.ai/guides/custom-objects)
