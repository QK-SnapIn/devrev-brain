...
category: sdks
source_url: https://developer.devrev.ai/sdks/web/install-search
last_updated: 2026-05-11
summary: "To get the Plug search widget to appear on your website and web app, insert the code snippet provided below on every page where you want the widget to appear for website visitors."
---
...
## [Bind a hotkey to toggle search agent](#bind-a-hotkey-to-toggle-search-agent)
...
## Source
- DevRev developer docs: [Install Plug search](https://developer.devrev.ai/sdks/web/install-search)
