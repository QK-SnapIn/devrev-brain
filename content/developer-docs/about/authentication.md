...
category: about
source_url: https://developer.devrev.ai/about/authentication
last_updated: 2026-05-11
summary: "Authentication to DevRev APIs requires a personal access token (PAT)."
---
...
## [Security token types](#security-token-types)
...
## [Personal access token usage](#personal-access-token-usage)
...
## [Generate a personal access token (PAT)](#generate-a-personal-access-token-pat)
...
![devrev-pat](/_next/image?url=%2F_next%2Fstatic%2Fmedia%2Fdevrev-pat.e02e3c78.png&w=3840&q=75&dpl=dpl_7YrfNpbg1U18B9yV3zCtUk5bPEKN)
...
Previous Page](/about/for-developers)[Pagination

Next Page](/about/pagination)

## Source
- DevRev developer docs: [Authentication](https://developer.devrev.ai/about/authentication)
