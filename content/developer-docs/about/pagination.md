...
category: about
source_url: https://developer.devrev.ai/about/pagination
last_updated: 2026-05-11
summary: "A lot of the time, when you're making calls to the DevRev API, there'll be a lot of results to return."
---
...
Previous Page](/about/authentication)[Versioning

Next Page](/about/versioning)

## Source
- DevRev developer docs: [Pagination](https://developer.devrev.ai/about/pagination)
