...
category: about
source_url: https://developer.devrev.ai/about/errors
last_updated: 2026-05-11
summary: "DevRev’s APIs use standard HTTP status codes when responding to requests."
---
...
Previous Page](/about/rate-limits)[Welcome

Next Page](/api-reference/getting-started)

## Source
- DevRev developer docs: [Errors](https://developer.devrev.ai/about/errors)
